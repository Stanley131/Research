...
stretch <- read.table("stretchVsTransport.txt",
    na.strings = "NA",
    col.names=c('Transport', 'LoadFactor', 'WorkLoad', 'MsgSizeRange',
...
for (rho in unique(tailStretch$LoadFactor)) {
    ...
    pdf(sprintf("plots/PBS_Graph/TailStretchVsUnschedBytes_rho%s.pdf",
